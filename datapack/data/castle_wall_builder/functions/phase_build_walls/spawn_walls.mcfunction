...
execute as @e[type=minecraft:marker,tag=castle_wall_builder_marker,scores={castle_wall_builder_parity=1},nbt={data:{type:"wall",step_size:3}}] at @s run data merge block ~ ~ ~ {name:"castle_wall_builder:wall_b_2step"}
